...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="b_per_create.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-actions">
					...
					<a class="w3-button w3-sand w3-round-xlarge" href="b_persons.php">Back</a>
				</div>
